...
$bet = new Bet();
$match_data = $bet->getMyKnockoutStageMatchData();
...
<div class="container-fluid">
    <div class="row">
         <div class="main center-block">
          	<h1 class="page-header">Knockout Stage</h1>
    				...
    				<table class="table table-striped">
    					...
    					<tbody>
    						...
    						<tr>
    							...
    							<td class="betcell"><a href="<?php echo $match['group_wiki']; ?>" target="_blank"><?php echo $match['stage_name']; ?></a></td>
    							<td class="betcell">
